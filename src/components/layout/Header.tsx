  ...
  return (
    <>
      ...
      >
        <div className="max-w-[1360px] mx-auto px-3 sm:px-4 lg:px-6">
          <div className="flex justify-between items-center h-12">
            ...
            <a href="/" className="flex items-center gap-2.5 group">
              ...
              <span className="font-display font-bold text-base md:text-lg text-primary tracking-tight leading-none">
                KARANWAL LIME CHEM
              </span>
            </a>

            {/* Desktop Navigation and CTA button grouped on the right to decrease gap */}
            <div className="hidden lg:flex items-center gap-6">
              <nav className="flex items-center gap-6">
                ...
                >
                  ...
                  <div
                    className={cn(
                      "absolute top-full right-0 lg:left-1/2 lg:-translate-x-1/2 w-[600px] bg-white shadow-xl rounded-lg border border-border-custom p-4 transition-all duration-200 mt-1 grid grid-cols-2 gap-2",
        ...
        {/* Mobile Navigation Drawer - Dynamic Positioning based on scroll */}
        <div
          className={cn(
            "lg:hidden fixed inset-x-0 bg-white border-b border-border-custom shadow-xl transition-all duration-300 ease-in-out z-30 overflow-y-auto",
            scrolled ? "top-[72px] max-h-[calc(100vh-72px)]" : "top-[80px] max-h-[calc(100vh-80px)]",
